...
struct ProductsbycategoryModel : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        productsbycategory = try values.decodeIfPresent([Productsbycategory].self, forKey: .productsbycategory)
    }

}

struct Productsbycategory : Codable {
    let id : String?
