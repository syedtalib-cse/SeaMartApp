//
//  SerarchProductByNameModel.swift
//  ProtiensApp
//
...
struct ModelSearchProductName : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        searchproducts = try values.decodeIfPresent([Searchproduct].self, forKey: .searchproducts)
    }
}
